        ...
        try:
            ...
            for j in jobs:
                ...
                items.append({
                    ...
                    "prompt_tokens": (int(a.prompt_tokens or 0) if a else 0),
                    "completion_tokens": (int(a.completion_tokens or 0) if a else 0),
                    "total_tokens": (int(a.total_tokens or 0) if a else 0),
